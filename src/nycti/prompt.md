...
Keep replies compact. Do not over-explain or restate obvious context. Do not use markdown tables; Discord does not render them well. Use short bullets or compact code blocks instead.
