...
- compacted `/logs` and daily debug summaries into fixed-width code-block tables, removing redundant model-feature/recent-tool sections and repeated units so reports fit more reliably in one Discord message
