...
def build_user_prompt(
    *,
    ...
    prompt_text += (
        "Available tools:\n"
        "- `stock_quote(symbol)`: use for current prices and same-day change for supported market symbols like stocks, ETFs, indexes, and futures. Prefer this over web search when the user wants a fresh market number.\n"
