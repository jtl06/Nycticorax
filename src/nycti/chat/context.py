...
def build_user_prompt(
    *,
    ...
    prompt_text += (
        "Available tools:\n"
        "- `stock_quote(symbol)`: use for current stock prices, bid/ask, and intraday change for listed U.S. tickers. Prefer this over web search when the user wants a fresh stock number.\n"
