...
def format_help_message(page: int = 1) -> str:
    pages = {
        ...
        2: (
            ...
            "- `/nickname add user:<member> alias:<name> [note:<text>]`, `/nickname delete alias:<name-or-id>`, `/nickname list`: manage member aliases (`Manage Server` required for add/delete)\n"
