...
def format_help_message(page: int = 1) -> str:
    pages = {
        1: (
            ...
            "- `/benchmark suite|failures|trace`: run real-LLM evals or inspect saved failures (`Manage Server`)\n"
            "- `/benchmark earnings|context|spacex|semis`: run a focused agent-loop benchmark\n"
